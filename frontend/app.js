(function () {
  ...
  function renderHeader() {
    ...
    if (!auth) {
      ...
      links.push({ href: 'profile.html', text: 'Профиль' }, { href: 'my-tickets.html', text: 'Мои билеты' });
      if (auth.role === 'admin') links.push({ href: 'admin.html', text: 'Админ' });
      links.push({ href: '#', text: 'Выход', id: 'logoutLink' });
    }
  ...
  function setupAuthPages() {
    ...
    if (loginForm) {
      loginForm.addEventListener('submit', (e) => {
        ...
        feedback(feedbackNode, true, 'Успешный вход. Переходим к событиям...');
